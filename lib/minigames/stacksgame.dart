...
// StacksGame widget
class StacksGame extends StatefulWidget {
  @override
  _StacksGameState createState() => _StacksGameState();
}

class _StacksGameState extends State<StacksGame> {
  ...
  void startGame() {
    ...
    _gameTimer = Timer.periodic(Duration(milliseconds: 250), (timer) {
      if (checkWinner()) {
        _showDialog();
        timer.cancel();
      }
